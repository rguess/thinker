...
public class FrontController {
	...
	public ModelAndView list(ModelAndView mav,@PathVariable("site") String site,@PathVariable("cid") Long cid) throws Exception {
		...
		Page<Article> pageData = articleService.findPage(pageRequest,andfilters,filters);
	...
	@RequestMapping("{site}/list.html")
	public ModelAndView list1(ModelAndView mav,@PathVariable("site") String site) throws Exception {
		mav.setViewName("/front/"+site+"/list");
		return mav;
	}
